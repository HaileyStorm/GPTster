...
class GPTConfig:
    ...
    # MUSIC
    # 9/10/640 = 47.38M, barely fits @ 6483 context (30 seconds) & micro-batch (`B`) = 1
    #   max_lr for 6483*20 = 4.5e-4
    n_layer: int = 9
    n_head: int = 10  # If 10/640 fails try 12/576
    n_embd: int = 640
    dropout: float = 0.06667
